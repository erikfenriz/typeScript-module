...
const getDog = d.getElementById("btn-dog"); // Button to fetch random dog
const dogImage = d.getElementById("dog-image"); // Image element for dog picture
const dogGallery = d.getElementById("dog-gallery"); // Container for all fetched dogs
...
function addDogToGallery(dogUrl) {
...
function updateDogStats() {
    const statsElement = d.getElementById('dog-stats');
